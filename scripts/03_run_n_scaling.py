"""Run N-scaling sweep (E5).

Usage:
    python scripts/03_run_n_scaling.py --config configs/E5_n_scaling.yaml --seed 42 [--n-views 4]
...
def main():
    ...
    logger = get_logger("03_n_scaling", out_dir / "train.log")
    ...
    raise NotImplementedError("Wire trainer per PLAN.md §10 / §E5")
