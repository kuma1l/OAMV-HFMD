"""Hotels-50K scaling (E10).

Usage:
    python scripts/08_hotels50k_scaling.py --config configs/E10_hotels50k.yaml --seed 42 [--n-views 4]
...
def main():
    ...
    logger = get_logger("08_h50k", out_dir / "train.log")
    ...
    raise NotImplementedError("Wire trainer per PLAN.md §10 / §E10")
