"""Train OAMV-HFMD variant (E2/E3/E4).

Usage:
    python scripts/02_train_oamvhfmd.py --config configs/E2_oamvhfmd_combined.yaml --seed 42 [--n-views 4]
...
def main():
    ...
    logger = get_logger("02_oamvhfmd", out_dir / "train.log")
    ...
    raise NotImplementedError("Wire trainer per PLAN.md §10 / §E2")
