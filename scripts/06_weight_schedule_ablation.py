"""Weight-schedule ablation (E8).

Usage:
    python scripts/06_weight_schedule_ablation.py --config configs/E8_weight_schedule.yaml --seed 42 [--n-views 4]
...
def main():
    ...
    logger = get_logger("06_weight", out_dir / "train.log")
    ...
    raise NotImplementedError("Wire trainer per PLAN.md §10 / §E8")
