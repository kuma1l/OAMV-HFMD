...
Usage:
    python scripts/05_oracle_ablation.py --config configs/E7_oracle_ablation.yaml --seed 42 [--n-views 4]
...
def main():
    ...
    logger = get_logger("05_oracle", out_dir / "train.log")
    ...
    raise NotImplementedError("Wire trainer per PLAN.md §10 / §E7")
