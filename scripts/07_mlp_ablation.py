"""MLP architecture ablation (E9).

Usage:
    python scripts/07_mlp_ablation.py --config configs/E9_mlp_ablation.yaml --seed 42 [--n-views 4]
...
def main():
    ...
    logger = get_logger("07_mlp", out_dir / "train.log")
    ...
    raise NotImplementedError("Wire trainer per PLAN.md §10 / §E9")
