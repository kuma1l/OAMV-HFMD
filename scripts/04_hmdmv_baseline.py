"""Train HMDMV baseline (E6).

Usage:
    python scripts/04_hmdmv_baseline.py --config configs/E6_hmdmv_baseline.yaml --seed 42 [--n-views 4]
...
def main():
    ...
    logger = get_logger("04_hmdmv", out_dir / "train.log")
    ...
    raise NotImplementedError("Wire trainer per PLAN.md §10 / §E6")
